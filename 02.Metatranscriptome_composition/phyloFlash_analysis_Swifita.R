...
## Bacteria
# import your files
table <- read.table(file = "I:/My Drive/Carballosa_Swiftia_Msphere_2026/Code_Data/bacteria.ALL_count_table.txt", sep = "\t", header = T) %>%
...
table <- read.table(file = "I:/My Drive/Carballosa_Swiftia_Msphere_2026/Code_Data/eukaryota.ALL_table_L7.txt", sep = "\t", header = T) %>%
